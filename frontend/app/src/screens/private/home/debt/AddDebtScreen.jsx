...
const AddDebtScreen = ({route, navigation}) => {
    ...
    const message_creation_successfully = [
        "Your debt has been created successfully."
    ]
    ...
    return (
        ...
        <Loading 
            title={'Creating'} 
            message={'Your debt is processing.'} 
            modalVisible={modalVisible}/>

        <ScrollView>
            <View style={ [theme.components.Card.style, styles.title] }>
                    <Text style={ theme.components.Subtitle.style }>Here you can add a new debt:</Text>

                    <CustomInput name='amount' 
                                 placeholder='Amount' 
                                 rules={ 
                                    { 
                                        required: "Amount of the debt is required."
                                    } 
                                 }
                                 control={control}/>
                    ...
                    <CustomInput name='description' 
                                 ...
                                 rules={ 
                                    { 
                                        required: "Description of the debt is required."
                                    } 
                                 }
                                 control={control}/>
                    ...
                    <Controller
                            rules = {{ required: "Date of the debt is required." }}
                            control={control}
